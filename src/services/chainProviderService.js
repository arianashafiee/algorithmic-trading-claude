...
export class ChainProviderService {
  ...
  getSolanaWalletService() {
    if (!this.solana) {
      throw new Error("Solana wallet service not initialized - provide SOLANA_PRIVATE_KEY");
    }
    return this.solana;
  }

  getSolanaService() {
    return this.getSolanaWalletService();
  }

  // Solana convenience methods
  async getSolanaBalance(cluster = 'mainnet-beta', address = null) {
    const solana = this.getSolanaWalletService();
...
export { ChainProviderService as BlockchainService };
