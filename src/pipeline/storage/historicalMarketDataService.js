// src/pipeline/storage/historicalMarketDataService.js
 ...
 */
export class HistoricalMarketDataService extends EventEmitter {
  constructor(options = {}) {
    super();
    
    this.logger = new PipelineLogger('HistoricalMarketDataService');
    this.options = {
  ...
  async initialize() {
    try {
      ...
      this.logger.info('HistoricalMarketDataService initialized');
    } catch (error) {
      this.logger.error('Failed to initialize HistoricalMarketDataService', error);
      throw error;
    }
  }
  ...
  async shutdown() {
    ...
    this.logger.info('HistoricalMarketDataService shutdown completed');
  }
}

export { HistoricalMarketDataService as HistoricalDataService };
