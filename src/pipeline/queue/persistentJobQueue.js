// src/pipeline/queue/persistentJobQueue.js
...
export class PersistentJobQueue extends EventEmitter {
  constructor(name, options = {}) {
    ...
    this.name = name;
    this.logger = new PipelineLogger(`PersistentJobQueue:${name}`);
    this.options = {
      dataDir: './queue-data',
      maxSize: 50000,
      retryAttempts: 3,
  ...
  /**
   * Queue management methods (same as MemoryJobQueue)
   */
  async pause() {
...
export { PersistentJobQueue as PersistentQueue };
