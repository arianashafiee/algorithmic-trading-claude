// src/pipeline/sources/cryptoMarketSource.js
 ...
 */
export class CryptoMarketSource extends EventEmitter {
  constructor(config) {
    super();
    ...
    this.logger = new PipelineLogger(`CryptoMarketSource:${this.config.exchange}`);
...
export { CryptoMarketSource as CryptoDataSource };
