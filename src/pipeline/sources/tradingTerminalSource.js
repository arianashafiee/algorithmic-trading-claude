// src/pipeline/sources/tradingTerminalSource.js
 ...
 */
export class TradingTerminalSource extends EventEmitter {
  constructor(config) {
    super();
    ...
    this.logger = new PipelineLogger('TradingTerminalSource');
...
export { TradingTerminalSource as CCTradingTerminalSource };
